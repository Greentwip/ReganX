...
protected:
	...
	UPROPERTY(Category="Character Movement: Climbing", EditAnywhere, meta=(ClampMin="0.1", ClampMax="10.0"))
	float CameraCatchupTime = 1.0f;  // 1 second
...
private:
	...
	FVector LastHitResult;
	
	FVector CurrentCameraLocation;
	
	UPROPERTY()
	TObjectPtr<UALSPlayerCameraBehavior> ALSCameraBehavior = nullptr;
