...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "ALS|Mantle System")
	void OnOwnerForwardBackwardInput(float Value);
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Mantle System")
	TObjectPtr<UTimelineComponent> ClimbTimeline = nullptr;
...
private:
	...
	EALSRotationMode ePreviousRotationMode;
};
