...
{
	const FName CameraSocketNameR = TEXT("TP_CameraTrace_R");
	const FName CameraSocketNameL = TEXT("TP_CameraTrace_L");
	
	TraceOrigin = (GetMesh()->GetSocketLocation(CameraSocketNameR) + GetMesh()->GetSocketLocation(CameraSocketNameL)) / 2;
	TraceRadius = 15.0f;
	return ECC_Camera;
}
